export default {
  ...
  strategyManager: {
    ...
    copyStrategyTitle: 'Copy Strategy',
    copyStrategyDesc: 'Create a new strategy based on the selected one',
    newStrategyName: 'New Strategy Name',
    copySuccess: 'Strategy copied successfully',
    copyFailed: 'Failed to copy strategy',
  },
